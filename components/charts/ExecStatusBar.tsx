...
export function ExecStatusBar({ items, customers }: { items: Item[]; customers: Customer[] }) {
  const counts = useMemo(() => dashboardStats(items, customers).execCounts, [items, customers]);
